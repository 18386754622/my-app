/**
  * alova 2.1.0 (https://alova.js.org)
...
function sendRequest(methodInstance, forceRequest) {
    ...
    const response = () => {
        ...
        return promisify(beforeRequest(clonedMethod)).then(() => {
            ...
            const { params = {}, headers = {}, localCache, transformData = self, name: methodInstanceName = '', shareRequest } = getConfig(clonedMethod);
...
function createRequestState(alovaInstance, methodHandler, useHookConfig, initialData, immediate = falseValue, watchingStates, debounceDelay = 0) {
    ...
    // 统一处理请求发送
    const handleRequest = (methodInstance = getHandlerMethod(methodHandler), useHookConfigParam = useHookConfig, sendCallingArgs, updateCacheState) => {
...
export { Method, createAlova, key as getMethodKey, invalidateCache, matchSnapshotMethod, queryCache, setCache, updateState, useFetcher, useRequest, useWatcher };
